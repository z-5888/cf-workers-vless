...
| `PROXYIP` | [点击获取](https://github.com/qwer-search/bestip/blob/main/kejilandbestip.txt){:target="_blank"} 也可自建,转发一个端口到任意 cf ip的443端口 |  代理IP，用于访问套了CF的站点|
|`UUID`  | `5zz1x235-1195-41pd-953v-0aafbd917b63` |生成或者符合格式的胡编乱造  |
| `WS_PATH` | `/123456` | ws路径，随意胡编乱造即可 |



基于[佬王仓库](https://markdown.lovejade.cn/?ref=markdown.lovejade.cn){:target="_blank"}修改，只修改了VLESS 感谢大佬无私！
